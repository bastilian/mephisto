...
class Admin::AdminNavTest < ActionController::TestCase
...
class Admin::MemberNavTest < ActionController::TestCase
  fixtures :sites, :users, :memberships
...
class Admin::GlobalAdminNavTest < ActionController::TestCase
  fixtures :sites, :users, :memberships
